  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('images/shem2.jpg') }}" alt="Shem">
          </div>
          <div class="name">
            <h5>
              Shem
      ...
      <div class="col-lg-3 col-md-6">
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('images/Nita (1).jpg') }}" alt="Trinitha Pricilia Barung">
          </div>
          <div class="name">
            <h5>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('images/aji (1).jpg') }}" alt="Nismat Hajjim Setyadi">
          </div>
          <div class="name">
            <h5>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('images/dapid (1).jpg') }}" alt="David Kalta Imanuel">
          </div>
          <div class="name">
            <h5>
              David Kalta Imanuel
